<div class="max">	
	<div ng-hide="hideToolbar" class="topcoat-navigation-bar">
	    ...
	    <div class="topcoat-navigation-bar__item right quarter">
	        <span ng-click="rightButtonClicked();" class="topcoat-icon-button--quiet" ng-hide="rightButtonIcon === '' || rightButtonIcon === undefined" ng-animate="'zoom'" style="vertical-align: middle">
